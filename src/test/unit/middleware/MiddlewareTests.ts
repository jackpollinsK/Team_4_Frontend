...
describe('Middleware', function () {
    ...
    describe('allowRoles', function () {
        it('should render notLoggedIn view and return 401 status, when user is NOT logged in', async () => {
            ...
            const req = {
                session: { token: '' }, //Empty token = not logged in
            };
    ...
    it('should render notAuthorised view and return 403 status, when user is logged in, but doesnt have correct role permission', async () => {
